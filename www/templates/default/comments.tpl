...
<form action="" method="post" class="form">
    ...
    <div class="textbox">
        <input type="text" name="comment_author" id="comment_author" value="{if $_POST['comment_author']}{$_POST['comment_author']}{else:}Имя{/if}" onfocus="if(this.value=='Имя') this.value='';" onblur="if(this.value=='') this.value='Имя';" />
    </div>
    ...
    <div class="textbox">
        <textarea name="comment_text" id="comment_text" rows="10" cols="50" onfocus="if(this.value=='Текст комментария') this.value='';" onblur="if(this.value=='') this.value='Текст комментария';">{if $_POST['comment_text']}{$_POST['comment_text']}{else:}Текст комментария{/if}</textarea>
    </div>
