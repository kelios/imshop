...
--
-- Host: localhost
-- Generation Time: Sep 16, 2011 at 05:02 PM
...
(65, 'Оплата', '', 'oplata', '', 'оплата', 'Оплата', '<p>Наш магазин поддерживает все доступные на данный момент методы оплаты.</p>\n<p>Также действует возможность оплаты курьеру при доставке для всех крупных городов Украины и России. (возможность оплаты курьеру в Вашем городе уточняйте по телефону <strong>0 800 820 22 22</strong>).</p>', '', 0, '', '', 0, 1, 0, 'publish', 'admin', 1291295824, 1291295836, 1291743521, 122, 3, 0),
...
(101, '', '', '', 'novosti_i_aktsii/', '', '', '', '', 56, '', '', 0, 1, 0, 'publish', 'kelios', 1316175516, 1316175516, 0, 0, 3, 0);
...
(1, 2, 'kelios', '$1$Rv4.Gd1.$wXevNKTe0JveUc3XXln9//', 'kelios@inbox.ru', 0, NULL, NULL, NULL, NULL, '127.0.0.1', '2011-09-16 18:01:47', '2011-09-15 11:20:20', '2011-09-16 17:01:47');
