...
<div id="productTabs">
        ...
        <div><!-- begin tovar tab -->
                ...
                <table cellpadding="4" id="variantsTable" class="variantsList">
                    ...
                    <tr id="ProductVariantRow_{$i}">
                        ...
                        <td>
                            ...
                            <input type="text" name="variants[Name][]" value="{echo ShopCore::encode($v->getName())}" class="textbox_long" />
                        </td>
                        <td><input type="text" name="variants[Price][]" value="{echo ShopCore::encode($v->getPrice())}" class="textbox_short" /></td>
                        ...
                        <td>
                            <img src="{$THEME}/images/minus.png" class="deleter" onClick="deleteVariant('ProductVariantRow_{$i}');"
            ...
            <div class="form_input">
				...
				<label><input type="checkbox" name="Hot"  value="1"  {if $model->getHot() == true}checked="checked"{/if} /> {echo $model->getLabel('Hot')}</label>
				<label><input type="checkbox" name="Action"  value="1"  {if $model->getAction() == true}checked="checked"{/if} /> {echo $model->getLabel('Action')}</label>
            </div>
            <div class="form_overflow"></div>
        ...
        <div class="rightBlockWithImages">
            ...
            <div style="width:400px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" height="90px" width="90px">
                        <tr>
                            <td>
                                ...
                                <a href="/uploads/shop/{echo $model->getId()}_main.jpg?{rand(1,9999)}" id="mainImagePrevLink" class="boxed" rel="{literal}{handler:'image'}{/literal}">
                                    <img src="/uploads/shop/{echo $model->getMainImage()}?{rand(1,9999)}" style="cursor:pointer;" width="90px" />
                                </a>
                                {/if}
                            </td>
                        </tr>
               ...
               <input type="file" onchange="$('mainImageName').set('html',document.getElementById('mainPhoto').value);" id="mainPhoto" name="mainPhoto" size="1" />
                ...
                {if $model->getMainImage() == true}
                    <img src="{$SHOP_THEME}images/delete.png"  style="padding-left:5px;margin-top:3px;cursor:pointer;"
            ...
            <div style="width:400px;">
               <div class="imageBoxStripe">
                    <table border="0" cellspacing="0" cellpadding="0" height="90px" width="90px">
                        <tr>
                            <td>
                                {if $model->getSmallImage() == true}
                                <a href="/uploads/shop/{echo $model->getId()}_small.jpg?{rand(1,9999)}" id="smallImagePrevLink" class="boxed" rel="{literal}{handler:'image'}{/literal}">
                                    <img src="/uploads/shop/{echo $model->getId()}_small.jpg?{rand(1,9999)}" style="cursor:pointer;" width="90px" />
                                    </a>
                                {/if}
                            </td>
                        </tr>
            ...
            <div class="form_input">
                <textarea class="mceEditor" name="ShortDescription" >{echo ShopCore::encode($model->getShortDescription())}</textarea>
            </div>
            <div class="form_overflow"></div>

            <div class="form_text">{echo $model->getLabel('FullDescription')}:</div>
            <div class="form_input">
                <textarea class="mceEditor" name="FullDescription" >{echo ShopCore::encode($model->getFullDescription())}</textarea>
            </div>
            <div class="form_overflow"></div>
            ...
            <div class="form_input">
                <input type="text" id="created" name="Created" value="{echo date('Y-m-d H:i:s',$model->getCreated())}" class="textbox_short" />
            </div>
            <div class="form_overflow"></div>
            ...
            <div class="form_input">
                <input type="text" name="OldPrice" value="{echo $model->getOldPrice()}" class="textbox_long" />
            </div>
            <div class="form_overflow"></div>
        ...
        <div> <!-- begin of properties tab -->
            <div id="productPropertiesContainer">
                {echo ShopCore::app()->SPropertiesRenderer->renderAdmin($model->getCategoryId(), $model)}
            </div>
        </div> <!-- end of properties tab -->

        <h4 title="Изображения">Изображения ({echo sizeof($additionalImagePositions)})</h4>
            ...
            <table border="0" cellpadding="10" id="additionalImagesTable">
                ...
                {for $i=0;$i<6;$i++}
                    <td>
                        <div class="imageBoxStripe" style="clear:both;">
                            <table border="0" cellspacing="0" cellpadding="0" height="90px" width="90px">
                                <tr>
                                    ...
                                    <a id="additionalImagePrevLink{$i}" href="/uploads/shop/{echo $additionalImagePositions[$i]->getImageName()}?{rand(1,9999)}" class="boxed" rel="{literal}{handler:'image'}{/literal}">
                                    <img src="/uploads/shop/{echo $additionalImagePositions[$i]->getImageName()}?{rand(1,9999)}" style="cursor:pointer;" width="90px" />
                                    </a>
                                        {/if}
                                    </td>
                                </tr>
                        ...
                        <a href="#" onclick="deleteAdditionalImage({$i}); return false;">Удалить</a>
                    </td>
                {/for}
                </tr>
