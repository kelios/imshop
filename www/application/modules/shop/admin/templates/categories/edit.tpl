...
<form method="post" action="{$ADMIN_URL}categories/edit/{$modelArray.Id}"  style="width:100%">
    ...
    <div class="form_input">
        <label><input type="checkbox" value="1"  {if $model->getActive() == true}checked="checked"{/if}  name="Active" /> {echo $model->getLabel('Active')}</label>
    </div>
    <div class="form_overflow"></div>
    ...
    <div class="form_input">
        <textarea class="mceEditor" name="Description" >{echo ShopCore::encode($modelArray.Description)}</textarea>
    </div>
    <div class="form_overflow"></div>
    <div class="form_text">{echo $model->getLabel('MetaDesc')}:</div>
    <div class="form_input">
        <input type="text" name="MetaDesc" value="{echo ShopCore::encode($modelArray.MetaDesc)}" class="textbox_long" />
    </div>
    <div class="form_overflow"></div>

    <div class="form_text">{echo $model->getLabel('MetaTitle')}:</div>
    <div class="form_input">
        <input type="text" name="MetaTitle" value="{echo ShopCore::encode($modelArray.MetaTitle)}" class="textbox_long" />
    </div>
    <div class="form_overflow"></div>

    <div class="form_text">{echo $model->getLabel('MetaKeywords')}:</div>
    <div class="form_input">
        <input type="text" name="MetaKeywords" value="{echo ShopCore::encode($modelArray.MetaKeywords)}" class="textbox_long" />
    </div>
    <div class="form_overflow"></div>
