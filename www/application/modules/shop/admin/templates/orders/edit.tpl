...
<div style="width:100%;position:relative;">
    <div style="float:left;width:50%;">
            ...
            <div class="form_input">
                ...
                <a href="http://maps.google.com/?q={echo ShopCore::encode($model->getUserDeliverTo())}" target="_blank" title="Посмотреть на карте.">
                    <img src="{$SHOP_THEME}images/map.png" style="padding-left:5px;" align="right" />
                </a>
            </div>
            <div class="form_overflow"></div>
