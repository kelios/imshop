...
abstract class BaseSPropertiesPeer {
	...
	const NAME = 'shop_product_properties.NAME';
	...
	const DATA = 'shop_product_properties.DATA';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CsvName', 'Active', 'ShowOnSite', 'ShowInCompare', 'Position', 'Data', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'csvName', 'active', 'showOnSite', 'showInCompare', 'position', 'data', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CSV_NAME, self::ACTIVE, self::SHOW_ON_SITE, self::SHOW_IN_COMPARE, self::POSITION, self::DATA, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CSV_NAME', 'ACTIVE', 'SHOW_ON_SITE', 'SHOW_IN_COMPARE', 'POSITION', 'DATA', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'csv_name', 'active', 'show_on_site', 'show_in_compare', 'position', 'data', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CsvName' => 2, 'Active' => 3, 'ShowOnSite' => 4, 'ShowInCompare' => 5, 'Position' => 6, 'Data' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'csvName' => 2, 'active' => 3, 'showOnSite' => 4, 'showInCompare' => 5, 'position' => 6, 'data' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CSV_NAME => 2, self::ACTIVE => 3, self::SHOW_ON_SITE => 4, self::SHOW_IN_COMPARE => 5, self::POSITION => 6, self::DATA => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CSV_NAME' => 2, 'ACTIVE' => 3, 'SHOW_ON_SITE' => 4, 'SHOW_IN_COMPARE' => 5, 'POSITION' => 6, 'DATA' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'csv_name' => 2, 'active' => 3, 'show_on_site' => 4, 'show_in_compare' => 5, 'position' => 6, 'data' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SPropertiesPeer::NAME);
			...
			$criteria->addSelectColumn(SPropertiesPeer::DATA);
		} else {
	 ...
	 */
	public static function addInstanceToPool(SProperties $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = SPropertiesPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + SPropertiesPeer::NUM_COLUMNS;
		} else {
	...
	/**
	 * Method perform an INSERT on the database, given a SProperties or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a SProperties or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the shop_product_properties table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a SProperties or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(SProperties $obj, $cols = null)
	{
		$columns = array();
