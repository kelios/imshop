 ...
 * @method     SCategoryQuery orderByMetaKeywords($order = Criteria::ASC) Order by the meta_keywords column
 ...
 * @method     SCategoryQuery groupByMetaKeywords() Group by the meta_keywords column
 ...
 * @method     SCategory findOneByMetaKeywords(string $meta_keywords) Return the first SCategory filtered by the meta_keywords column
 ...
 * @method     array findByMetaKeywords(string $meta_keywords) Return SCategory objects filtered by the meta_keywords column
...
abstract class BaseSCategoryQuery extends ModelCriteria
{
	...
	public function filterByMetaKeywords($metaKeywords = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(SCategoryPeer::META_KEYWORDS, $metaKeywords, $comparison);
	}
