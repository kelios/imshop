...
abstract class BaseSCategory extends ShopBaseObject  implements Persistent
{
	...
	public function setMetaKeywords($v)
	{
		...
		if ($this->meta_keywords !== $v) {
			...
			$this->modifiedColumns[] = SCategoryPeer::META_KEYWORDS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->meta_desc = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			...
			$this->full_path = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->full_path_ids = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->resetModified();
			...
			return $startcol + 12; // 12 = SCategoryPeer::NUM_COLUMNS - SCategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[10] => $this->getFullPath(),
			$keys[11] => $this->getFullPathIds(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setMetaDesc($arr[$keys[5]]);
		...
		if (array_key_exists($keys[10], $arr)) $this->setFullPath($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setFullPathIds($arr[$keys[11]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SCategoryPeer::META_KEYWORDS)) $criteria->add(SCategoryPeer::META_KEYWORDS, $this->meta_keywords);
