...
abstract class BaseSProducts extends ShopBaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->hit = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->hot = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->action = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->brand_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->category_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->related_products = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->mainimage = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->smallimage = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->short_description = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->full_description = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->meta_title = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->meta_description = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->meta_keywords = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->old_price = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->created = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->updated = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->views = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
			$this->resetModified();
			...
			return $startcol + 21; // 21 = SProductsPeer::NUM_COLUMNS - SProductsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[9] => $this->getRelatedProducts(),
			$keys[10] => $this->getMainimage(),
			$keys[11] => $this->getSmallimage(),
			$keys[12] => $this->getShortDescription(),
			$keys[13] => $this->getFullDescription(),
			$keys[14] => $this->getMetaTitle(),
			$keys[15] => $this->getMetaDescription(),
			$keys[16] => $this->getMetaKeywords(),
			$keys[17] => $this->getOldPrice(),
			$keys[18] => $this->getCreated(),
			$keys[19] => $this->getUpdated(),
			$keys[20] => $this->getViews(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setHit($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setHot($arr[$keys[5]]);
		...
		if (array_key_exists($keys[9], $arr)) $this->setRelatedProducts($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setMainimage($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setSmallimage($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setShortDescription($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setFullDescription($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setMetaTitle($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setMetaDescription($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setMetaKeywords($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setOldPrice($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setCreated($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setUpdated($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setViews($arr[$keys[20]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SProductsPeer::HOT)) $criteria->add(SProductsPeer::HOT, $this->hot);
		if ($this->isColumnModified(SProductsPeer::ACTION)) $criteria->add(SProductsPeer::ACTION, $this->action);
		...
		if ($this->isColumnModified(SProductsPeer::OLD_PRICE)) $criteria->add(SProductsPeer::OLD_PRICE, $this->old_price);
		...
		if ($this->isColumnModified(SProductsPeer::VIEWS)) $criteria->add(SProductsPeer::VIEWS, $this->views);
	 ...
	 * @return     void
	 */
	public function initSProductImagess()
	{
	...
	public function getSProductImagess($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSProductImagess || null !== $criteria) {
			if ($this->isNew() && null === $this->collSProductImagess) {
				...
				$collSProductImagess = SProductImagesQuery::create(null, $criteria)
	 ...
	 *
	 * @param      SProductImages $l SProductImages
	 * @return     void
	 * @throws     PropelException
	 */
	 ...
	 * @return     void
	 */
	public function initSWarehouseDatas()
	{
	...
	public function getSWarehouseDatas($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSWarehouseDatas || null !== $criteria) {
			if ($this->isNew() && null === $this->collSWarehouseDatas) {
				...
				$collSWarehouseDatas = SWarehouseDataQuery::create(null, $criteria)
					->filterBySProducts($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 *
	 * @param      SWarehouseData $l SWarehouseData
	 * @return     void
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @param      SProductsRating $v SProductsRating
	 * @return     SProducts The current object (for fluent API support)
	 * @throws     PropelException
	 */
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collSProductImagess) {
				foreach ((array) $this->collSProductImagess as $o) {
			...
			if ($this->collSWarehouseDatas) {
				foreach ((array) $this->collSWarehouseDatas as $o) {
					$o->clearAllReferences($deep);
				}
			}
