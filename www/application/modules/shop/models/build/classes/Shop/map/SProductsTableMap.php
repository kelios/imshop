...
class SProductsTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('HOT', 'Hot', 'BOOLEAN', false, null, null);
		$this->addColumn('ACTION', 'Action', 'BOOLEAN', false, null, null);
    ...
    $this->addRelation('SProductImages', 'SProductImages', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), 'CASCADE', null);
    $this->addRelation('ProductVariant', 'SProductVariants', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), null, null);
    $this->addRelation('SWarehouseData', 'SWarehouseData', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), null, null);
