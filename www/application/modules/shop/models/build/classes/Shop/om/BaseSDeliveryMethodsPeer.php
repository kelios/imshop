...
abstract class BaseSDeliveryMethodsPeer {
	...
	const NAME = 'shop_delivery_methods.NAME';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'shop_delivery_methods.DESCRIPTION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'Price', 'FreeFrom', 'Enabled', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'price', 'freeFrom', 'enabled', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DESCRIPTION, self::PRICE, self::FREE_FROM, self::ENABLED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DESCRIPTION', 'PRICE', 'FREE_FROM', 'ENABLED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'price', 'free_from', 'enabled', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'Price' => 3, 'FreeFrom' => 4, 'Enabled' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'price' => 3, 'freeFrom' => 4, 'enabled' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DESCRIPTION => 2, self::PRICE => 3, self::FREE_FROM => 4, self::ENABLED => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, 'PRICE' => 3, 'FREE_FROM' => 4, 'ENABLED' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'price' => 3, 'free_from' => 4, 'enabled' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SDeliveryMethodsPeer::NAME);
			$criteria->addSelectColumn(SDeliveryMethodsPeer::DESCRIPTION);
	 ...
	 */
	public static function addInstanceToPool(SDeliveryMethods $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = SDeliveryMethodsPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + SDeliveryMethodsPeer::NUM_COLUMNS;
		} else {
	...
	/**
	 * Method perform an INSERT on the database, given a SDeliveryMethods or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a SDeliveryMethods or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the shop_delivery_methods table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a SDeliveryMethods or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(SDeliveryMethods $obj, $cols = null)
	{
		$columns = array();
