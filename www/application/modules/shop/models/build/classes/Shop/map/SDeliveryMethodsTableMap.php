...
class SDeliveryMethodsTableMap extends TableMap {
	...
	{
    $this->addRelation('ShopDeliveryMethodsSystems', 'ShopDeliveryMethodsSystems', RelationMap::ONE_TO_MANY, array('id' => 'delivery_method_id', ), 'CASCADE', null);
    $this->addRelation('SOrders', 'SOrders', RelationMap::ONE_TO_MANY, array('id' => 'delivery_method', ), 'SET NULL', null);
    $this->addRelation('PaymentMethods', 'SPaymentMethods', RelationMap::MANY_TO_MANY, array(), 'SET NULL', null);
	} // buildRelations()
