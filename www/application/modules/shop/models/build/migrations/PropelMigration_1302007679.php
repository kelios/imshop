 ...
 * up to version 1302007679.
 * Generated on 2011-04-05 16:47:59 by firstrow
 */
class PropelMigration_1302007679
{
...
ALTER TABLE `shop_user_profile` CHANGE `name` `name` VARCHAR(255);
...
ALTER TABLE `shop_user_profile` CHANGE `name` `name` VARCHAR(255) NOT NULL;
