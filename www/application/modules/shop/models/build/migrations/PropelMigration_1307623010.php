 ...
 * up to version 1307623010.
 * Generated on 2011-06-09 12:36:50 
 */
class PropelMigration_1307623010
{
...
ALTER TABLE `shop_products` CHANGE `new` `hot` TINYINT;
...
ALTER TABLE `shop_products` CHANGE `hot` `new` TINYINT;
