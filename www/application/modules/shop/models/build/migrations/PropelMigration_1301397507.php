 ...
 * up to version 1301397507.
 * Generated on 2011-03-29 15:18:27 by firstrow
 */
class PropelMigration_1301397507
{
...
DROP INDEX `shop_category_I_3` ON `shop_category`;

DROP INDEX `shop_category_I_4` ON `shop_category`;

ALTER TABLE `shop_category` ADD
(
	`active` TINYINT
);

CREATE INDEX `shop_category_I_3` ON `shop_category` (`active`);

CREATE INDEX `shop_category_I_4` ON `shop_category` (`parent_id`);

CREATE INDEX `shop_category_I_5` ON `shop_category` (`position`);
...
DROP INDEX `shop_category_I_5` ON `shop_category`;

DROP INDEX `shop_category_I_3` ON `shop_category`;

DROP INDEX `shop_category_I_4` ON `shop_category`;

ALTER TABLE `shop_category` DROP `active`;

CREATE INDEX `shop_category_I_3` ON `shop_category` (`parent_id`);

CREATE INDEX `shop_category_I_4` ON `shop_category` (`position`);
