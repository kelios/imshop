 ...
 * up to version 1294760037.
 * Generated on 2011-01-11 17:33:57 
 */
class PropelMigration_1294760037
{
...
ALTER TABLE `shop_discounts` CHANGE `min_price` `min_price` FLOAT (6,2);

ALTER TABLE `shop_discounts` CHANGE `max_price` `max_price` FLOAT (6,2);

ALTER TABLE `shop_discounts` ADD
(
	`description` TEXT
);
...
ALTER TABLE `shop_discounts` DROP `description`;
