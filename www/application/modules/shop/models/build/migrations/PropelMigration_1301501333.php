 ...
 * up to version 1301501333.
 * Generated on 2011-03-30 20:08:53 by firstrow
 */
class PropelMigration_1301501333
{
...
ALTER TABLE `shop_products` ADD CONSTRAINT `shop_products_FK_3`
	FOREIGN KEY (`id`)
...
ALTER TABLE `shop_products` DROP FOREIGN KEY `shop_products_FK_3`;
