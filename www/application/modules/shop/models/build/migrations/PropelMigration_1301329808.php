 ...
 * up to version 1301329808.
 * Generated on 2011-03-28 20:30:08 by firstrow
 */
class PropelMigration_1301329808
{
...
DROP INDEX `shop_product_properties_I_2` ON `shop_product_properties`;

DROP INDEX `shop_product_properties_I_3` ON `shop_product_properties`;

ALTER TABLE `shop_product_properties` ADD
(
	`show_on_site` TINYINT
);

CREATE INDEX `shop_product_properties_I_2` ON `shop_product_properties` (`active`);

CREATE INDEX `shop_product_properties_I_3` ON `shop_product_properties` (`show_on_site`);

CREATE INDEX `shop_product_properties_I_4` ON `shop_product_properties` (`show_in_compare`);

CREATE INDEX `shop_product_properties_I_5` ON `shop_product_properties` (`position`);
...
DROP INDEX `shop_product_properties_I_4` ON `shop_product_properties`;

DROP INDEX `shop_product_properties_I_5` ON `shop_product_properties`;

DROP INDEX `shop_product_properties_I_2` ON `shop_product_properties`;

DROP INDEX `shop_product_properties_I_3` ON `shop_product_properties`;

ALTER TABLE `shop_product_properties` DROP `show_on_site`;

CREATE INDEX `shop_product_properties_I_2` ON `shop_product_properties` (`show_in_compare`);

CREATE INDEX `shop_product_properties_I_3` ON `shop_product_properties` (`position`);
